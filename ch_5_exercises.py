...
def joke():
    print("Whats the best thing about Switzerland? ")
    print("I dont know, but the flag is a big plus. ")
...
def main():
    print("I have a knock-knock joke for you")
    line_1()
    line_2()
    line_3()
    line_4()
...
def get_name():
    ...
    print(f"Hello {name2}, I am greeting you")
...
def main5():
    r = random.randint(1, 11)  # TODO generate a random integer between 1-10, assign it to the variable r
    r2 = r * r
    area(r2)
