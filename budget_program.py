...
monthly_phone_bill = float(input("How much do you spend on your phone bill each month? "))
...
total_phone = monthly_phone_bill / total_monthly_income
...
total_spent = monthly_housing + monthly_food + monthly_transportation + monthly_phone_bill + monthly_utilities + monthly_clothing
leftover_spending = total_monthly_income - total_spent
print(f"You have ${leftover_spending:.2f} left from your income after paying these monthly expenses")