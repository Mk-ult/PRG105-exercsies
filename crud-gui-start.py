...
class CrudGUI:
	def __init__(self, master):
		...
		default_font.configure(size=19)
...
class AddGUI:
	def __init__(self, master):
		...
		self.mid_frame = tkinter.Frame(self.look)
		...
		self.email_label = tkinter.Label(self.mid_frame, text='Enter Customer email: ')
		self.email_entry = tkinter.Entry(self.mid_frame, width=20)
...
class ChangeGUI:
    def __init__(self, master):
        ...
        self.add_button = tkinter.Button(self.bottom_frame, text='search', command=self.search, width=10)
        self.back_button = tkinter.Button(self.bottom_frame, text='Main Menu', command=self.go_back, width=10)
